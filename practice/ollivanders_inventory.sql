...
-- The minimum number of galleons needed for The minimum number of galleons needed for The minimum number of galleons needed for

-- The data for wands of age 20 (code 4):

--     The minimum number of galleons needed for 

-- The minimum number of galleons needed for The minimum number of galleons needed for
...
AND w.coins_needed = (
    ...
    FROM wands a
    INNER JOIN wands_property r
    ON a.code = r.code
    WHERE r.is_evil = 0 AND w.power = a.power AND p.age = r.age
)
